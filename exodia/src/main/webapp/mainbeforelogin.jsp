...
.btn {
  ...
  *margin-left: .3em;
  ...
  vertical-align: middle;
  cursor: pointer;
  background-color: rgb(172, 130, 255);
  *background-color: rgb(172, 130, 255);
  background-image: -moz-linear-gradient(top, rgb(172, 130, 255), rgb(172, 130, 255));
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#ffffff), to(#e6e6e6));
  background-image: -webkit-linear-gradient(top, rgb(172, 130, 255), rgb(172, 130, 255));
  background-image: -o-linear-gradient(top, rgb(172, 130, 255), rgb(172, 130, 255));
  background-image: linear-gradient(to bottom, rgb(172, 130, 255), rgb(172, 130, 255));
  background-repeat: repeat-x;
  border: 1px solid #cccccc;
  *border: 0;
...
.btn-warning {
  color: #ffffff;
  text-shadow: 0 -1px 0 rgba(0, 0, 0, 0.25);
  background-color: #8040fe;
  *background-color: #f89406;
  background-image: -moz-linear-gradient(top, #8040fe, #8040fe);
  background-image: -webkit-gradient(linear, 0 0, 0 100%, from(#fbb450), to(#f89406));
  background-image: -webkit-linear-gradient(top, #8040fe, #8040fe);
  background-image: -o-linear-gradient(top, #8040fe, #8040fe);
  background-image: linear-gradient(to bottom, #8040fe, #8040fe);
  background-repeat: repeat-x;
